    ...
    <div className="bg-zinc-800 rounded-2xl p-4 overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <div className="min-w-[560px]">
          <div className="grid grid-cols-3 sm:grid-cols-5 text-[11px] sm:text-xs text-zinc-400 border-b border-zinc-700/50 pb-2">
            <div>Time</div>
            <div>Price</div>
            <div>Qty</div>
          ...
          <div className="divide-y divide-zinc-800 max-h-56 md:max-h-64 overflow-y-auto">
            {trades.map((t) => (
              <div key={t.id} className="grid grid-cols-3 sm:grid-cols-5 text-sm py-1 tabular-nums font-mono">
